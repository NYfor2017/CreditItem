...
public class UserSerivceImpl implements UserService{
	...
	public int updateUser(String username, String password, boolean member, String realName, boolean gender,
			...
			String address_living_2, String photo) {
		return userDao.updateUser(username, password, member, realName, gender, idcard, phone_number, address_original, address_living_1, address_living_2,photo);
	}
