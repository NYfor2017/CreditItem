...
public class UserController {
	...
	private String update(@RequestParam("username")String username, @RequestParam("password")String password, @RequestParam("member")boolean member, @RequestParam("realName")String realName,
			...
			@RequestParam("address_living_1")String address_living_1, @RequestParam("address_living_2")String address_living_2) {
		int u = userService.updateUser(username, password, member, realName, gender, idcard, phone_number, address_original, address_living_1, address_living_2);
		if(u>-1)
			return "/user";
		return "/failure";
	}
